...
## 📌 Project Overview
The UK’s Net-Zero Strategy requires doubling on-shore wind capacity by 2030[cite: 73, 75]. However, modern turbines near the EKA can emit ground vibrations (0.5–8 Hz) that potentially mask low-magnitude nuclear signals[cite: 125, 126]. This study provides a regulator-ready tool to quantify these effects and ensure compliance with the **0.336 nm RMS displacement** statutory limit[cite: 36, 128].
